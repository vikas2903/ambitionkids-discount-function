...
const app = UNSAFE_withComponentProps(function App3() {
  ...
  if (!apiKey) {
    return /* @__PURE__ */ jsx("s-page", {
      heading: "App configuration error",
      children: /* @__PURE__ */ jsx("s-section", {
        heading: "Missing SHOPIFY_API_KEY",
        children: /* @__PURE__ */ jsxs("s-paragraph", {
          children: ["The embedded app could not initialize because the", /* @__PURE__ */ jsx("code", {
            children: " SHOPIFY_API_KEY "
